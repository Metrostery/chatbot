...
def Speech_to_Text():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            txtSpeech.insert(tk.END, "Freeman: " + my_text + "\n\n")
    ...
    while(True):
        ...
        if(my_text.strip()==''):
            ...
            txtSpeech.insert(tk.END, "Little Freeman: " + gemini_text + "\n") 
            engine=pyttsx3.init()
...
RootFrame=tk.Frame(root,width=1000, height=600, bd=20, bg="blue")
RootFrame.pack()

MainFrame=tk.Frame(RootFrame,width=950, height=500, bd=20)

lbltitle = tk.Label(MainFrame, font= ('poppins',50,'bold'),width=20, text= "Freeman Chatbot")
lbltitle.pack()
